            ...
            [
                [
                        InlineKeyboardButton(
                            ...
                            url=f"https://t.me/https://dreambotsupdates")
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 𝚂𝙲𝙰𝚁𝙻𝙴𝚃𝚃 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
